...
df.info()
df.describe().T
# TotalCharge numerik bir değisken olmasına ragmen kategorik gözüküyor onu düzeltiyoruz.

df["TotalCharges"] = pd.to_numeric(df["TotalCharges"], errors='coerce')

# Churn ise base model oluşturulmasında bağımlı değişken olduğu için  binary hale getirilmelidir.
...
#############################################
# 1. Değişkenlerin tipine göre ayrılması
#############################################
